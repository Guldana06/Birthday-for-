...
const portalsData = [
    { photo: 'photo1.jpg', title: 'Самой прекрасной жеңге', text: 'Дорогая жеңге, мы хотим сказать, как сильно все рады, что вы есть в нашей семье. Вы не просто жена нашего брата, вы стали для нас родным человеком.' },
    { photo: 'photo2.jpg', title: 'Источник уюта и тепла', text: 'Любимая жеңге, глядя на вас с братом, мы видим, сколько гармонии вы приносите в его жизнь.' },
    { photo: 'photo3.jpg', title: 'Восхищение вами', text: 'Наша дорогая жеңге, вы невероятная девушка! Мы всегда восхищаемся вашим очарованием.' },
    { photo: 'photo4.jpg', title: 'Ваша невероятная улыбка', text: 'Жеңге, ваша улыбка способна осветить любой, даже самый пасмурный день.' },
    ...
    { photo: 'photo6.jpg', title: 'Самая стильная', text: 'Жеңге, вы всегда выглядите потрясающе! Вашему чувству стиля можно только позавидовать.' },
    { photo: 'photo7.jpg', title: 'С днем рождения! 🎉', text: '🎆✨ Дорогая жеңге! От всего сердца поздравляем вас! Пусть в вашей жизни всегда царят любовь, уют и благополучие! 🎂🎈🎁' }
];
